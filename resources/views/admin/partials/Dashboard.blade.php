                ...
                <div class="vcarousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="active item">
                            <div class="overlaybg"><img src="../plugins/images/heading-bg/slide6.jpg" alt="heading1" /></div>
                        ...
                        <div class="item">
                            <div class="overlaybg"><img src="../plugins/images/heading-bg/slide4.jpg" alt="heading2" /></div>
                            <div class="news-content"><span class="label label-primary label-rounded">Primary</span>
                                <h2>It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</h2> <a href="#">Read More</a></div>
                        </div>
                        <div class="item">
                            <div class="overlaybg"><img src="../plugins/images/heading-bg/slide6.jpg" alt="heading3" /></div>
