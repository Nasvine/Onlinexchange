                        ...
                        <form class="form-horizontal" action="{{ route('user.admin.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" name="phone_1" class="form-control" value="{{ $user->phone_1 }}"> 
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" name="phone_2" class="form-control" value="{{ $user->phone_2 }}"> 
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" name="numero_ifu" class="form-control" value="{{ $user->numero_ifu }}"> 
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                            ...
                            <div class="form-group m-b-0">
                                <div class="col-sm-offset-3 col-sm-9">
                                    <button type="submit" class="btn btn-info waves-effect waves-light m-t-10 pull-right">Valider</button>
                                </div>
                            </div>
                        </form>
                    </div>
