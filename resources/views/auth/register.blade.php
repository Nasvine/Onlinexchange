        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-6">
                    <div class="me-lg-5">   
                        <img src="{{ asset('accueil/images/user/signup.svg') }}" class="img-fluid d-block mx-auto" alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6">
                    <div class="card shadow rounded border-0">
                        <div class="card-body">
                            ...
                            <form method="POST" class="login-form mt-4" action="{{ route('register') }}">
                                    @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input type="text" class="form-control ps-5" placeholder="First Name"  name="first_name"  required autofocus autocomplete="first_name">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3"> 
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input type="text" class="form-control ps-5" placeholder="Last Name" name="last_name"  required autofocus autocomplete="last_name">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input type="email" class="form-control ps-5" placeholder="Email" name="email" required autocomplete="username">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                <i data-feather="key" class="fea icon-sm icons"></i>
                                                <input type="password" class="form-control ps-5" placeholder="Confirm password" 
                                                name="password_confirmation" required autocomplete="new-password">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Code de Parrainage <span class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
                                                <i data-feather="key" class="fea icon-sm icons"></i>
                                                <input type="number" class="form-control ps-5" placeholder="Code de Parrainage" 
                                                name="code_de_parrainage">
                                            </div>
                                        </div>
                                    </div><!--end col-->
