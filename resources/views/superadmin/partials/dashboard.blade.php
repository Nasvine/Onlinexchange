    ...
    <div class="col-xl-8">														
        <div class="box no-shadow mb-0 bg-transparent">
            <div class="box-header no-border px-0">
                <h4 class="box-title">Vos Cours</h4>							
                        ...
                        <div class="act-div">
                            <div class="bg-gray-100 p-15 rounded10 mb-20">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <img src="../images/avatar/1.jpg" class="avatar avatar-sm me-10 avatar-pill">
                                        <p class="text-fade fs-12 mb-0">Johen doe</p>
                                    </div>
                                    <p class="text-fade fs-12 mb-0">08 Nov 2020</p>
                                </div>
                            </div>
                            <div class="bg-gray-100 p-15 rounded10 mb-20">
                                <div>
                                    <span class="badge badge-sm badge-dot badge-primary me-5"></span>
                                    Biometric
                                </div>
                                <h4 class="my-20">Explain what do you know about<br> Biometric! (&gt;100 words)</h4>
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <img src="../images/avatar/2.jpg" class="avatar avatar-sm me-10 avatar-pill">
                                        <p class="text-fade fs-12 mb-0">Mical doe</p>
                                    </div>
                                    <p class="text-fade fs-12 mb-0">08 Nov 2020</p>
                                </div>
                            </div>
