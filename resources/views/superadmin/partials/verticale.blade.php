			  ...
			  <ul class="sidebar-menu" data-widget="tree">	
				...
				<li class="treeview">
					<a href="#">
					  ...
					  <span style="font-size: 13px;">Gestion des utilisateurs</span>
					  <span class="pull-right-container">
						<i class="fa fa-angle-right pull-right mt-1"></i>
					  </span>
					</a>
					<ul class="treeview-menu">
					  <li><a href="{{ route('role.admin.index') }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Role</a></li>
					  <li><a href="{{ route('permission.admin.index') }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Permission</a></li>	
					  <li><a href="{{ route('user.admin.index') }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Utilisateur</a></li>
					</ul>
				  </li>
				  <li>
					<a href="{{ route('verificationcompte.users.index') }}">
					  <i class="icon-Layout-4-blocks"><span class="path1"></span><span class="path2"></span></i>
					  <span>Verifier Compte</span>
					</a>
				</li>  
				<li>
					<a href="{{ route('monnaire.admin.index') }}">
