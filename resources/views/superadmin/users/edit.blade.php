            ...
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('user.admin.index') }}"><i class="mdi mdi-home-outline"></i>Accueil</a></li>
			...
			<div class="col-12">
			  <div class="box">
				...
				<div class="box-header">
                    <div class="row">
                        <div class="col-lg-9 col-md-4 col-sm-4 col-xs-12">
                            <h3 class="box-title">Formulaire pour modifier un utilisateur</h3>
                        </div>
				...
				<div class="box-body">
                    ...
                    <form class="form-horizontal" action="{{ route('user.admin.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        value="{{ $user->profile->adresse ?? 'Ex: Pahou/Soglocodji'}} "
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="phone_1" class="form-control" value="{{ $user->profile->phone_1 ?? 'Ex:+229 12455588' }}"> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="phone_2" class="form-control" value="{{ $user->profile->phone_2 ?? 'Ex:+229 12455588' }}"> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" name="numero_ifu" class="form-control" value="{{ $user->profile->numero_ifu ?? 12547}}"> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" name="code_de_parrainage" class="form-control" value="{{ $user->code_de_parrainage }}"> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="lien_de_parrainage" class="form-control" value="{{ $user->lien_de_parrainage }}"> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
