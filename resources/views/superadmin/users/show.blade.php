        ...
        <div class="d-flex align-items-center">
            <div class="me-auto">
                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('user.admin.index') }}"><i class="mdi mdi-home-outline"></i>Utilisateurs</a></li>
            ...
            <div class="box box-widget widget-user">
               ...
               <div class="widget-user-image">
                @if(isset($user->profile) && $user->profile->image_photo)
                     <img class="rounded-circle" src="{{ asset('utilisateurs/images/image_profile/'.$user->profile->image_photo) }}" alt="User Avatar">
                @endif
                   ...
                   <div class="col-12">
                       <div>
                           ...
                           @if(isset($user->profile) && $user->profile->image_photo)
                                ...
                                <p> <u>Adresse  : </u> <span class="text-gray ps-10">{{ $user->profile->adresse }}</span></p>
                           @endif
