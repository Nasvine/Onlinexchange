...
@section('content')
    ...
    @component('users.components.breadcrumb')
        ...
        @slot('title') @lang('translation.message') @endslot --}}
    @endcomponent
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-sm-4 float-end" >
                        @if (Auth::user()->type_de_compte == "mini")
                            <a href="#" class="btn btn-warning " style="font-size: 10px">Compte mini</a>
                        @else
                            <a href="#" class="btn btn-primary " style="font-size: 10px">Compte standard</a>
                        @endif  
                    </div>
                    <div class="col-sm-8 ">
                        <div class="mb-4 me-3">
                            {{-- <i class="mdi mdi-account-circle text-primary h1"></i> --}}
                            <img class="rounded-circle header-profile-user" src="{{ asset('template_users/assets/images/users/avatar-1.jpg') }}" alt="">
                        </div>
                ...
                <div class="card-body border-top">
                    <div class="row">
                        <div class="col-sm-12">
                            <div>
                                <p class="fw-medium mb-2 text-center fs-5">Acheter et vendre vos cryptos</p>

                                <p class="text-center">Démarrer une transaction !</p>
                                {{-- 
                                    
                                <h4>$ 6134.39</h4> 
                                
                                <a href="#" class="btn btn-warning me-2 w-md">Compte mini</a>
                                --}}
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            {{-- 
                                <a href="#" class="btn btn-primary me-2 w-md">Vérifer</a>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div>
                                ...
                                <h4>$ 6134.39</h4> --}}
                                <a href="{{ route('achat.users.index') }}" class="btn btn-info me-2 w-md">Acheter</a>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <a href="{{ route('vente.users.index') }}" class="btn btn-danger me-2 w-md">Vendre</a>
        ...
        <div class="col-xl-8">
            <div class="card">
                <div>
                    @if (Auth::user()->statut_de_compte == "non verifier")
                        <div class="row">
                            <div class="col-lg-9 col-sm-8">
                                <div class="p-4">
                                    <h5 class="text-primary">Bienvenue sur votre Dashboard !</h5>
                                    <p>Actuellement vous avez un compte mini, pour pouvoir passer à un compte Standard afin d'effectuer plus de transaction au delà de 1000$, 
                                        cliquer sur le bouton Vérifier</p>

                                        <a href="{{ route('verification.users.index') }}" class="btn btn-primary me-2 w-md">Vérifer</a>
                            ...
                            <div class="col-lg-3 col-sm-4 align-self-center">
                                <div>
                                    <img src="{{ URL::asset('template_users/assets/images/crypto/features-img/img-1.png') }}" alt="" class="img-fluid d-block">
                                </div>
                            </div>
                        </div>
                    @elseif (Auth::user()->statut_de_compte == "en cours")    
                        <div class="row">
                            <div class="col-lg-9 col-sm-8">
                                <div class="p-4">
                                    <h5 class="text-primary">Bienvenue sur votre Dashboard !</h5>
                                    <p>Votre compte est toujours en cours de vérication, veuillez Patientez...</p>
                    ...
                    @elseif (Auth::user()->statut_de_compte == "verifier")
                        <div class="row">
                            <div class="col-lg-9 col-sm-8">
                                <div class="p-4">
                                    <h5 class="text-primary">Bienvenue sur votre Dashboard !</h5>
                                    <p>Votre compte e été vérifier.</p>
                    ...
                    @elseif (Auth::user()->statut_de_compte == "rejecter")
                        <div class="row">
                            <div class="col-lg-9 col-sm-8">
                                <div class="p-4">
                                    <h5 class="text-primary">Bienvenue sur votre Dashboard !</h5>
                                    <p>votre compte a été rejecté, veuillez cliquer sur le bouton Voir motif pour voir le metif et effectuer une nouvelle vérification.</p>

                                        <a href="{{ route('verification.users.index') }}" class="btn btn-primary me-2 w-md">Voir motif</a>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p class="text-muted mb-4"><i
                                    class="mdi mdi-bitcoin h2 text-warning align-middle mb-0 me-3"></i> SOLDE BITCOIN </p>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="text-muted mb-4"><i
                                    class="mdi mdi-ethereum h2 text-primary align-middle mb-0 me-3"></i> SOLDE EN FCFA </p>
                    ...
                    <ul class="list-group" data-simplebar style="max-height: 390px;">
                            ...
                            <div class="media">
                                <div class="avatar-xs me-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{ URL::asset('template_users/assets/images/companies/img-1.png') }}" alt="" height="18">
                                    </span>
                                </div>
                        ...
                        <li class="list-group-item border-0">
                            <div class="media">
                                <div class="avatar-xs me-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{ URL::asset('template_users/assets/images/companies/img-2.png') }}" alt="" height="18">
                                    </span>
                                </div>
                                <div class="media-body">
                        ...
                        <li class="list-group-item border-0">
                            <div class="media">
                                <div class="avatar-xs me-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{ URL::asset('template_users/assets/images/companies/img-3.png') }}" alt="" height="18">
                                    </span>
                                </div>
                                <div class="media-body">
                        ...
                        <div class="tab-pane active" id="buy-tab" role="tabpanel">
                            <div class="float-end ms-2">
                                <h5 class="font-size-14"><i
                                        class="bx bx-wallet text-primary font-size-16 align-middle me-1"></i> $4235.23</h5>
                            </div>
...
@section('script')
    <!-- apexcharts -->
    <script src="{{ URL::asset('template_users/assets/libs/apexcharts/apexcharts.min.js') }}"></script>
    <!-- crypto dash init js -->
    <script src="{{ URL::asset('template_users/assets/js/pages/crypto-dashboard.init.js') }}"></script>
@endsection