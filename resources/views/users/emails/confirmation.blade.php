            ...
            <table cellpadding="0" cellspacing="0" style="font-family: Nunito, sans-serif; font-size: 15px; font-weight: 400; max-width: 600px; border: none; margin: 0 auto; border-radius: 6px; overflow: hidden; background-color: #fff; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15);">
                ...
                <tbody>
                    <tr style="background-color: #7a7b7c; padding: 3px 0; border: none; line-height: 68px; text-align: center; color: #fff; font-size: 24px; letter-spacing: 1px;">
                        <th scope="col"><img src="images/logo-light.png" height="24" alt="">{{ $mailconfirm['title'] }}</th>
                    </tr>
                    <tr>
                        <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                            Hello, {{ $mailconfirm['first_name_of_users'] }} {{ $mailconfirm['last_name_of_users'] }}.
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            Félicitation !!!
                            Votre compte sur <b>Onlinexchange</b> a été vérifié avec succès.  Veuillez vous connecter à votre profil 
                            pour acheter et vendre vos crypto-monnaires.
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
