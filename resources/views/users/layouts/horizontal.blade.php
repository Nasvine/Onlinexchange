        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <!-- item-->
                    <a href="{{ route('index/en') }}" class="dropdown-item notify-item language" data-lang="eng">
                    ...
                    <!-- item-->
                    <a href="{{ route('index/es') }}" class="dropdown-item notify-item language" data-lang="sp">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('template_users/assets/images/users/avatar-1.jpg') }}"
                        alt="Header Avatar">
