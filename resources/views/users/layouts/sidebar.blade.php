            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('root') }}" class="waves-effect">
                        ...
                        <span key="t-dashboards">{{-- @lang('translation.Dashboards') --}} Dashboard</span>
                    </a>
                ...
                <li>
                    <a href="{{ route('transaction.users.index') }}" class="waves-effect">
                        <i class="bx bx-file"></i>
                        {{-- <span class="badge rounded-pill bg-success float-end"
                            key="t-new">@lang('translation.New')</span> --}}
                        <span key="t-file-manager">{{-- @lang('translation.File_Manager') --}} Transactions</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('achat.users.index') }}" class="waves-effect">
                        <i class="bx bx-calendar"></i>
                        <span key="t-calendar">{{-- @lang('translation.Calendar') --}} Achats</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('vente.users.index') }}" class="waves-effect">
                        <i class="bx bx-calendar"></i>
                        <span key="t-calendar">{{-- @lang('translation.Calendar') --}} Ventes</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('retrait.users.index') }}" class="waves-effect">
                        <i class="bx bx-chat"></i>
                        <span key="t-chat">{{-- @lang('translation.Chat') --}} Retrait d'argent</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('parrainage.users.index') }}" class="waves-effect">
                        <i class="bx bx-chat"></i>
                        <span key="t-chat">{{-- @lang('translation.Chat') --}} Parrainage</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('contact.users.index') }}" class=" waves-effect">
                        <i class="bx bxs-user-detail"></i>
                        <span key="t-contacts">{{-- @lang('translation.Contacts') --}} Contactez-nous</span>
                    </a>
                    {{-- <ul class="sub-menu" aria-expanded="false">
                ...
                <li>
                    <a href="javascript: void(0);" class=" waves-effect">
                        <i class="bx bxs-user-detail"></i>
                        <span key="t-contacts">{{-- @lang('translation.Contacts') --}} Guide utilisateur</span>
                    </a>
                    {{-- <ul class="sub-menu" aria-expanded="false">
                        <li><a href="contacts-grid" key="t-user-grid">@lang('translation.User_Grid')</a></li>
                        <li><a href="contacts-list" key="t-user-list">@lang('translation.User_List')</a></li>
